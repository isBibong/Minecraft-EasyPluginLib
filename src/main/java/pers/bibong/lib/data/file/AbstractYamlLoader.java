...
public abstract class AbstractYamlLoader {
    ...
    public AbstractYamlLoader (@NotNull JavaPlugin plugin, String fileName) {
        this(plugin, "", fileName, false);
    }

    public AbstractYamlLoader (@NotNull JavaPlugin plugin, String path, String fileName, boolean createFolder) {
        this.plugin   = plugin;
